    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <StatCard
          title="Repeat Rate"
          value={
            report?.summary.repeatRate != null
              ? `${report.summary.repeatRate.toFixed(1)}%`
              : "-"
          }
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <BarChart
          ...
          xKey="bookingCount"
          bars={[{ dataKey: "customerCount", name: "Customers" }]}
          loading={isLoading}
          empty={bookingCountData.length === 0}
        />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <PieChart
          ...
          loading={isLoading}
          empty={bookingCountPieData.length === 0}
        />
